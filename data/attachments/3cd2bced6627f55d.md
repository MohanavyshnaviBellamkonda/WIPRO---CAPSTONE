...
- Name: Navigation/navigation.spec.js >> Navigation Service - DemoBlaze >> NAV_012 Verify Signup modal opens
- Location: tests/Navigation/navigation.spec.js:112:9
...
Call log:
  ...
  - waiting for locator('#signInModalLabel')
    13 × locator resolved to <h5 class="modal-title" id="signInModalLabel">Sign up</h5>
