...
- Name: Authentication/auth.spec.js >> Authentication Service - DemoBlaze >> AUTH_009 Verify signup with empty username and password
- Location: tests/Authentication/auth.spec.js:89:9
...
Call log:
  ...
  - attempting click action
    ...
    - <a href="#" id="nameofuser" class="nav-link">Welcome Vyshnavi_26</a> from <li class="nav-item">…</li> subtree intercepts pointer events
